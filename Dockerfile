...
RUN echo "Cheaky 'pinentry' replacement, make sure that RBW_MASTER_PASSWORD environment variable is set during execution..."
RUN install -m 0700 /tmp/rbw_master_password_from_env.py /usr/local/bin/rbw_master_password_from_env.py
