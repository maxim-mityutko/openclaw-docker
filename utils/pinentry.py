...
BITWARDEN_MASTER_PASSWORD_ENV = "BITWARDEN_MASTER_PASSWORD"
...
password = os.environ.get(BITWARDEN_MASTER_PASSWORD_ENV)
if password is None:
    print(f"ERR 83886179 {BITWARDEN_MASTER_PASSWORD_ENV} is not set", flush=True)
    sys.exit(1)
